...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/09 21:22:07 by alacrois          #+#    #+#             */
/*   Updated: 2017/12/11 18:23:27 by alacrois         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "main.h"

static int		get_t_divergence(t_complex c, int iterations)
{
	int			i;
	t_complex	z;
	double		tmp;
				...
				double limit)
{
	...
	divergence = get_t_divergence(c, f->max_iterations);
